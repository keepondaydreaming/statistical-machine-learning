...
def add_noise_data(input_data, input_labels, n_points, mean, scale):
    ...
    for i in range(n_points):
        ...
        # We add more difficulties for decision tree
...
if __name__ == "__main__":
    ...
    Xtrain, ytrain = add_noise_data(and_X, and_y, n_train, 0.0, std_train)
    ...
    # Xtest, ytest = add_noise_data(and_X, and_y, n_test, 0.0, std_test)
